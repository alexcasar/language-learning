...
# python tests/langPCAg.py ~/Desktop/snet/gits/lang-learn-repo/alex_tests/data data11 3_3
'''
...
for v in varnames:
    ...
    batch_dir = path+"/"+filename+"/lang/"+v+"_PCAg_"+par
    ...
    try:
        kwargs = {  # defaults
            ...
            'word_space'    :   'sparse'  ,   # 'vectors' / 'discrete' - no dimensionality reduction
            ...
            'clustering'    :   'agglomerative'     ,   # 'kmeans' / 'group'~'identical_entries' / future options
